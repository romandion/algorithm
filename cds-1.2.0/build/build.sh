...
case $OS_FAMILY in
    ...
    mingw*)
        OS_FAMILY=mingw
        ;;
    linux|sunos|hpux|aix|freebsd|mingw)
		;;
    *)
	...
	gcc|clang)
		case $processor_arch in
			amd64)
				case $OS_FAMILY in
					linux|freebsd)
						buildCXXflags="-m64 -fPIC $amd64_cxx_options"
						buildCflags="-m64 -fPIC $amd64_cxx_options"
			...
			x86)
				case $OS_FAMILY in
					linux|freebsd)
						buildCXXflags="-m32 -fPIC -march=pentium4"
						buildCflags="-m32 -fPIC -march=pentium4"
