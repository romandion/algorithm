...
namespace cds { namespace container {
    ...
    /** @ingroup cds_nonintrusive_queue
        ...
        - opt::value_cleaner - a functor to clean item dequeued. Default value is \ref opt::v::empty_cleaner
    ...
    */
    ...
    protected:
        ...
        {
            typedef cds::opt::v::empty_cleaner  value_cleaner   ;
    ...
    protected:
        ...
        typedef cds::details::trivial_assign<value_type, value_type> trivial_copy   ;
