...
namespace cds { namespace container {
    ...
    */
    ...
    public:
        ...
        typedef Value                               value_type      ;   ///< Type of value stored in the list
        typedef std::pair<key_type const, value_type> pair_type     ;   ///< key/value pair stored in the list
#else
        typedef typename options::key_type          key_type        ;
        typedef typename options::value_type        value_type      ;
        typedef typename options::pair_type         pair_type       ;
#endif
    ...
    protected:
        //@cond
        template <typename K>
        node_type * alloc_node(const K& key)
        {
            return cxx_allocator().New( key )    ;
        }

        template <typename K, typename V>
        node_type * alloc_node( const K& key, const V& val )
        {
    ...
    protected:
        ...
        public:
            ...
            typedef typename cds::details::make_const_type<pair_type,  IsConst>::reference  pair_ref;
            typedef typename cds::details::make_const_type<pair_type,  IsConst>::pointer    pair_ptr;
    ...
    public:
        ...
        /**
            ...
            - <tt> operator -> </tt> - returns a pointer to \ref pair_type for iterator
            - <tt> operator *</tt> - returns a reference (a const reference for \p const_iterator) to \ref pair_type for iterator
            - <tt> const key_type& key() </tt> - returns a key reference for iterator
            - <tt> value_type& val() </tt> - retuns a value reference for iterator (const reference for \p const_iterator)
    ...
    public:
        ...
        */
        ...
        /**
            ...
            - The \ref value_type should be default-constructible.
        ...
        */
        ...
        /**
            ...
            \code void func( value_type& itemValue ) ;
                struct functor {
        ...
        */
        ...
        {
            return node_to_iterator( find_at( head(), key ) ) ;
        }
    ...
    protected:
        ...
        {
            node_type * pNode = alloc_node( key )   ;
        ...
        {
            node_type * pNode = alloc_node( key, val )   ;
            assert( pNode != null_ptr<node_type *>() ) ;
            if ( base_class::insert_at( &refHead, *pNode ))
                return pNode    ;
        ...
        std::pair< node_type *, bool > ensure_at( head_type& refHead, const K& key )
        {
            ...
            assert( func.m_pItemFound != null_ptr<node_type *>() ) ;

            if ( !ret.second )
                free_node( pNode )  ;
            return std::make_pair( func.m_pItemFound, ret.second )  ;
        }

        template <typename K>
        node_type * find_at( head_type& refHead, const K& key )
        {
