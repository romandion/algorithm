    ...
    */
    ...
    private:
        ...
        struct erase_functor
        {
            ...
            {
                cds::unref(m_func)( const_cast<pair_type&>(node.m_Data) )    ;
            }
        };
        //@endcond
    ...
    public:
        ...
        */
        ...
        /**
            ...
            \code
                void func( bool bNew, pair_type& item ) ;
            \endcode
            or a functor:
            \code
                struct my_functor {
    ...
    protected:
        ...
        bool insert_at( head_type& refHead, const K& key, const V& val )
        {
            ...
            assert( pNode != null_ptr<node_type *>() ) ;
            assert( pNode->m_pNext.load(memory_model::memory_order_relaxed) == null_ptr<node_type *>() ) ;
