...
namespace cds { namespace container {
    ...
    /** @ingroup cds_nonintrusive_map
        ...
        There is a specialization for \ref cds::gc::nogc declared in <tt>cds/container/split_list_map_nogc.h</tt>,
        ...
        The second attention: instead of using MichaelList in SplitListMap traits we use a tag <tt>cds::contaner::michael_list_tag</tt> for the Michael's list.
        ...
        Now you are ready to declare our set class based on SplitListMap:
        \code
    ...
    */
    ...
    public:
        ...
        typedef Value                   value_type      ;   ///< type of value stored in the map

        typedef std::pair<key_type const, value_type>   pair_type   ;   ///< Pair type
    ...
    protected:
        ...
        public:
            ...
            template <typename Q>
            void operator()( bool bNew, pair_type& item, const Q& /*val*/ )
            {
        ...
        public:
            ...
            template <typename Q>
            void operator()( pair_type& pair, Q const& /*val*/ )
            {
                base_class::get()( pair ) ;
            }
        };
    ...
    public:
        ...
        /**
            Remember, the iterator <tt>operator -> </tt> and <tt>operator *</tt> returns \ref pair_type pointer and reference.
    ...
    public:
        ...
        */
        ...
        bool insert( K const& key )
        {
            ...
            return base_class::insert( std::make_pair( key, value_type() ) ) ;
        }
        ...
        */
        ...
        {
            //TODO: pass arguments by reference (make_pair makes copy)
            return base_class::insert( std::make_pair( key, value_type() ), func ) ;
        }
        ...
        */
        ...
        std::pair<bool, bool> ensure( K const& key, Func func )
        {
            ...
            //TODO: pass arguments by reference (make_pair makes copy)
            return base_class::ensure( std::make_pair( key, value_type() ), cds::ref(fw) )  ;
        }
