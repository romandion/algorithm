...
namespace cds { namespace container {
    ...
    */
    ...
    protected:
        //@cond
        template <typename Q>
        node_type * alloc_node( const Q& v )
        {
    ...
    public:
        ...
        */
        template <typename Q, typename Func>
        bool insert( const Q& key, Func func )
        {
        ...
        */
        template <typename Q, typename Func>
        std::pair<bool, bool> ensure( const Q& key, Func f )
        {
    ...
    protected:
        ...
        template <typename Q, typename Func>
        bool erase_at( head_type& refHead, const Q& key, Func f )
        {
        ...
        template <typename Q>
        bool find_at( head_type& refHead, const Q& key )
        {
