...
namespace cds { namespace container {
    ...
    */
    ...
    public:
        ...
        typedef typename bucket_type::value_type        value_type      ;   ///< value type
        typedef typename bucket_type::pair_type         pair_type       ;   ///< key/value pair stored in the list
    ...
    protected:
        ...
        */
        ...
        public:
            ...
            typedef typename cds::details::make_const_type<typename MichaelHashMap::value_type, IsConst>::pointer   value_ptr;
            /// Value reference type (const for const_iterator)
            typedef typename cds::details::make_const_type<typename MichaelHashMap::value_type, IsConst>::reference value_ref;

            /// Key-value pair pointer type (const for const_iterator)
            typedef typename cds::details::make_const_type<typename MichaelHashMap::pair_type, IsConst>::pointer   pair_ptr;
            /// Key-value pair reference type (const for const_iterator)
            typedef typename cds::details::make_const_type<typename MichaelHashMap::pair_type, IsConst>::reference pair_ref;
    ...
    public:
        ...
        */
        ...
        ) : m_nHashBitmask( michael_map::details::init_hash_bitmask( nMaxItemCount, nLoadFactor ))
        {
            ...
            static_assert(( boost::is_same<gc, typename bucket_type::gc>::value ), "GC and OrderedList::gc must be the same")  ;
