...
/** \mainpage CDS: Concurrent Data Structures library
   ...
   Supported processor architectures and operating systems (OS) are:
      - x86 [32bit] linux, windows, freeBSD
      - amd64 (x86-64) [64bit] linux, windows, freeBSD
   ...
   Prerequisites: for building <b>cds</b> library and test suite you need:
    ...
    - <a href="http://www.boost.org/">boost library</a> 1.39 and above. You should create environment variable
   ...
   Other GCs (cds::gc::HRC, cds::gc::PTB) are applied analogously.
    ...
    After that, you can use \p cds lock-free containers safely without
    any synchronization.
...
namespace cds {
    ...
    /**
        This type is synonym for <tt>std::intptr_t</tt>
    */
    typedef intptr_t ptr_atomic_t    ;

    /// atomic unsigned int sized as pointer
    /**
        This type is synonym for <tt>std::uintptr_t</tt>
    */
