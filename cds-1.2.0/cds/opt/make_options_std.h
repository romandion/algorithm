...
namespace cds { namespace opt {
    ...
    struct find_type_traits {
        typedef typename find_type_traits_option< O1,
            typename find_type_traits_option< O2,
                typename find_type_traits_option< O3,
                    typename find_type_traits_option< O4,
                        typename find_type_traits_option< O5,
                            typename find_type_traits_option< O6,
                                typename find_type_traits_option< O7,
                                    typename find_type_traits_option< O8,
                                        typename find_type_traits_option< O9,
                                            typename find_type_traits_option< O10,
                                                typename find_type_traits_option< O11,
                                                    typename find_type_traits_option< O12,
                                                        typename find_type_traits_option< O13,
                                                            typename find_type_traits_option< O14,
                                                                typename find_type_traits_option< O15,
                                                                    typename find_type_traits_option< O16, DefaultOptions>::type
                                                                >::type
                                                            >::type
                                                        >::type
                                                    >::type
