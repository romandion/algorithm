...
#   endif
        ...
        {
        private:
            typename cds::details::aligned_type<T, sizeof(T)>::type volatile m_atomic ;
            //T volatile  m_atomic ;
        ...
        public:
            ...
            {
                atomic_ops::atomic_store_explicit( &m_atomic, val, order )  ;
            }
            ...
            {
                return atomic_ops::atomic_load_explicit( &m_atomic, order ) ;
            }
            ...
            {
                return atomic_ops::atomic_exchange_explicit( &m_atomic, val, order )    ;
            }
            ...
            {
                return atomic_ops::atomic_compare_exchange_weak_explicit( &m_atomic, &expected, desired, success_order, failure_order )  ;
            }
            ...
            {
                return atomic_ops::atomic_compare_exchange_strong_explicit( &m_atomic, &expected, desired, success_order, failure_order )  ;
            }
            ...
            {
                return atomic_ops::atomic_fetch_add_explicit( &m_atomic, val, order )    ;
            }
            ...
            {
                return atomic_ops::atomic_fetch_sub_explicit( &m_atomic, val, order )    ;
            }
            ...
            {
                return atomic_ops::atomic_fetch_and_explicit( &m_atomic, val, order )    ;
            }
            ...
            {
                return atomic_ops::atomic_fetch_or_explicit( &m_atomic, val, order )    ;
            }
            ...
            {
                return atomic_ops::atomic_fetch_xor_explicit( &m_atomic, val, order )    ;
            }
...
#   undef CDS_DECLARE_ATOMIC_INTEGRAL
    ...
    public:
        ...
        {
            return atomic_ops::atomic_fetch_add_explicit( &m_atomic, offset, order )    ;
        }
        ...
        {
            return atomic_ops::atomic_fetch_sub_explicit( &m_atomic, offset, order )    ;
        }
