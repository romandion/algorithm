    ...
    namespace bitop {
        ...
        namespace details {
            ...
            template <> struct BitOps<4> {
                ...
                static TUInt    RandXorShift()      { return bitop::platform::RandXorShift32(); }
            };
            ...
            template <> struct BitOps<8> {
                ...
                static TUInt    RandXorShift()        { return bitop::platform::RandXorShift64();   }
            };
        }    // namespace details
        //@endcond
        ...
        */
        ...
        template <typename T>
        static inline T RandXorShift()
        {
            return (T) details::BitOps< sizeof(T) >::RandXorShift() ;
        }
