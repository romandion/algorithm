        ...
        */
        ...
        namespace details {
            ...
            class rebind_list_options
            {
                ...
                struct key_compare {
                    int operator()( value_type const& v1, value_type const& v2 )
                    {
                    ...
                    template <typename Q>
                    int operator()( value_type const& v, search_value_type<Q> const& q )
                    {
                    ...
                    template <typename Q>
                    int operator()( search_value_type<Q> const& q, value_type const& v )
                    {
                        return -operator()( v, q )  ;
                    }
                };
