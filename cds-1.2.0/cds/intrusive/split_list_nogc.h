...
#   endif
    ...
    protected:
        ...
        public:
            ...
            template <typename Q>
            list_iterator find_at_( dummy_node_type * pHead, split_list::details::search_value_type<Q> const & val )
            {
                assert( pHead != null_ptr<dummy_node_type *>() ) ;
                bucket_head_type h(static_cast<list_node_type *>(pHead)) ;
                return base_class::find_at_( h, val )   ;
            }
    ...
    protected:
        ...
        iterator find_( Q const & val )
        {
            ...
            return iterator( m_List.find_at_( pHead, sv ), m_List.end() ) ;
        }
