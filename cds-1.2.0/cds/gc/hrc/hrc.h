...
namespace cds { namespace gc {
    ...
    \par Sources:
        ...
        The cds::gc::hrc namespace and its members are internal representation of the GC and should not be used directly.
        Use cds::gc::HRC class in your code.
        ...
        by contructing cds::gc::HRC object in beginning of your main().
        See cds::gc::HRC class for explanation.
    */
    namespace hrc {
        ...
        */
        ...
        protected:
            ...
            CDS_ATOMIC::atomic<bool>    m_bTrace    ;    ///< @a true - node is tracing by Scan
            CDS_ATOMIC::atomic<bool>    m_bDeleted  ;    ///< @ true - node is deleted
