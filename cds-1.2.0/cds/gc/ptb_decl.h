...
#   endif
        ...
        */
        ...
        public:
            ...
            */
            ...
            T * get() const
            {
                return reinterpret_cast<T *>( base_class::get_guard()->pPost.load(CDS_ATOMIC::memory_order_relaxed) )   ;
            }
        };
        ...
        public:
            ...
            */
            ...
            T protect(size_t nIndex, CDS_ATOMIC::atomic<T> const& toGuard )
            {
                ...
                } while ( pRet != toGuard.template load(CDS_ATOMIC::memory_order_acquire))    ;
            ...
            */
            ...
            {
                return reinterpret_cast<T *>( base_class::operator[](nIndex).get_guard()->pPost.load(CDS_ATOMIC::memory_order_relaxed) )   ;
            }
    ...
    public:
        ...
        */
        ...
        {
            retire( p, disposer<Disposer, T>::dispose ) ;
        }
