        ...
        namespace details {
            ...
            public:
                ...
                guard_data * alloc()
                {
                    ...
                    {
                        cds::lock::Auto<SpinLock> al( m_freeListLock )  ;
            ...
            */
            ...
            public:
                ...
                /// Result of \ref privatize function.
                /**
            ...
            */
            ...
            private:
                ...
                {
                    return m_nCurEpoch.load(CDS_ATOMIC::memory_order_relaxed) & (c_nEpochCount - 1);
                }
                unsigned int next_epoch() const
                {
                    return (m_nCurEpoch.load(CDS_ATOMIC::memory_order_relaxed) - 1) & (c_nEpochCount - 1);
                }
                //@endcond
            ...
            public:
                ...
                void inc_epoch()
                {
                    m_nCurEpoch.fetch_add( 1, CDS_ATOMIC::memory_order_relaxed ) ;
                }
        ...
        public:
            ...
            /**
                ...
                \li \p nLiberateThreshold - the liberate threshold. When count of retired pointers reaches this value,
                    the \ref liberate member function would be called for freeing retired pointers.
