    ...
    namespace hzp {
        ...
        */
        ...
        private:
            ...
            // We cannot use atomic<hplist_node *> for m_pListHead
            // since MSVC2008 generate a warning:
            //   warning C4251: 'cds::gc::hzp::GarbageCollector::m_pHPRecListHead' : class 'cds::atomic<T>'
            //   needs to have dll-interface to be used by clients of class 'cds::gc::hzp::GarbageCollector'
        ...
        public:    // Internals for threads
            ...
            /**
                ...
                - \ref classic_scan allocates memory for internal use
                - \ref inplace_scan does not allocate any memory

                Use \ref setScanType function to setup appropriate scan algorithm.
            */
        ...
        protected:
            ...
            */
            ...
            /**
                Unlike the \ref classic_scan algorithm, \p inplace_scan does not allocate any memory.
