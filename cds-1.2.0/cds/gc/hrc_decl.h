...
#   endif
            ...
            /**
                ...
                \p T - class derived from \ref container_node type
            */
        ...
        */
        ...
        public:
            ...
            */
            ...
            T * get() const
            {
                return static_cast<T *>( base_class::get())   ;
            }
        };
        ...
        public:
            ...
            */
            ...
            T * protect( size_t nIndex, atomic_ref<T> const& link )
            {
                T * p    ;
                do {
                    p = assign( nIndex, link.load(CDS_ATOMIC::memory_order_acquire) ) ;
                } while ( p != link.load(CDS_ATOMIC::memory_order_relaxed) ) ;
                return p    ;
            }
            ...
            */
            ...
            typename atomic_marked_ptr<T>::marked_ptr protect( size_t nIndex, atomic_marked_ptr<T> const& link )
            {
                ...
                do {
                    assign( nIndex, ( p = link.load(CDS_ATOMIC::memory_order_acquire)).ptr() ) ;
                } while ( p != link.load(CDS_ATOMIC::memory_order_relaxed) ) ;
                return p    ;
            }
            ...
            */
            ...
            {
                return static_cast<T *>( base_class::operator[](nIndex).get() )   ;
            }
