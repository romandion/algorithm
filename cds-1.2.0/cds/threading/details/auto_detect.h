...
#       if !defined(CDS_THREADING_MSVC) && !defined(CDS_THREADING_WIN_TLS)
...
#           if !defined(CDS_THREADING_GCC) && !defined(CDS_THREADING_WIN_TLS)
#               define CDS_THREADING_WIN_TLS
#           endif
#       elif !defined(CDS_THREADING_GCC) && !defined(CDS_THREADING_PTHREAD)
