    ...
    protected:
        ...
        void analyze( CppUnitMini::ThreadPool& pool, QUEUE& testQueue  )
        {
            ...
            for ( CppUnitMini::ThreadPool::iterator it = pool.begin(); it != pool.end(); ++it ) {
                ...
                CPPUNIT_ASSERT_EX( pThread->m_nRepeatValue == 0, "nRepeatValue=" << pThread->m_nRepeatValue )  ;
            ...
            CPPUNIT_ASSERT_MSG( nPushTotal == nTotalItems, "nPushTotal=" << nPushTotal << ", nTotalItems=" << nTotalItems ) ;
            CPPUNIT_ASSERT_MSG( nPopTotal == nTotalItems, "nPopTotal=" << nPopTotal << ", nTotalItems=" << nTotalItems ) ;
