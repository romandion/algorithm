...
#define TEST(X)     void TreiberIntrusiveTestHeader::test_##X() { test<X>(); }
    ...
    namespace {
        typedef cds::intrusive::TreiberStack< cds::gc::HP,
            TreiberIntrusiveTestHeader::base_hook_item<cds::gc::HP>
        > Treiber_HP_default    ;
        ...
        // HZP GC + member hook
        typedef cds::intrusive::TreiberStack< cds::gc::HP,
            TreiberIntrusiveTestHeader::member_hook_item<cds::gc::HP>
            ,ci::opt::hook<
                ci::single_link::member_hook<
                    offsetof(TreiberIntrusiveTestHeader::member_hook_item<cds::gc::HP>, hMember),
                    ci::opt::gc<cds::gc::HP>
                >
            >
        > Treiber_HP_member    ;
...
CPPUNIT_TEST_SUITE_REGISTRATION(stack::TreiberIntrusiveTestHeader)    ;
